...
if (isset($_POST["deposit_amount"]) && isset($_POST["pin_no"]))
{
	...
	while($row1 = mysql_fetch_assoc($query1))
	{
		...
		$sql2 = "INSERT INTO Transaction_History VALUES ('$account_no', '$time', '$deposit_amount', '1') ";
		...
		while ($row3 = mysql_fetch_assoc($query3))
		{
			...
			$final_balance = $balance + $deposit_amount ;
